...
let xsyScmWaterMarkIntervalId: NodeJS.Timer | null = null;
...
const watermark = {
    ...
    set: function (id, str) {
        ...
        //每隔1分钟检查一次水印
        xsyScmWaterMarkIntervalId = setInterval(() => {
            setWatermark(id, str);
        }, 60000);
    ...
    clear: function () {
        ...
        if (xsyScmWaterMarkIntervalId) {
            clearInterval(xsyScmWaterMarkIntervalId);
            xsyScmWaterMarkIntervalId = null;
        }
    },
};
