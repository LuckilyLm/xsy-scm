...
<template>
  <!--
      ...
      3、底部（一般是公司版权信息）
     -->
  <a-layout class="help-doc-layout" id="xsyScmMain">
    <!-- 顶部头部信息 -->
    ...
    <a-layout :style="`height: ${windowHeight}px`">
      ...
      <!--中间内容-->
      <a-layout-content id="xsyScmLayoutContent" class="help-doc-layout-content">
...
<script setup lang="ts">
  ...
  import logoImg from '/@/assets/images/logo/xsy-scm-logo-white.png';
