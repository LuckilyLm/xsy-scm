<template>
  <view class="menu-container">
    <uni-grid :column="5" :highlight="true" :show-border="false" customStyle="display: block;">
      ...
      <uni-grid-item class="menu-grid" style="width: 134rpx; height: 134rpx">
        <view class="menu-item" @click="navigateTo('/pages/order/order-list')">
          <image class="item-image" src="@/static/images/index/ic_home_menu10.png"></image>
          <view class="item-text"> 销售订单 </view>
        </view>
      </uni-grid-item>

      <uni-grid-item class="menu-grid" style="width: 134rpx; height: 134rpx">
        <view class="menu-item" @click="navigateTo('/pages/finance/receivable-list')">
          <uni-icons type="money" size="40" color="#1a9aff" style="margin-bottom: 10rpx"></uni-icons>
          <view class="item-text"> 应收单 </view>
        </view>
      </uni-grid-item>
      <uni-grid-item class="menu-grid" style="width: 134rpx; height: 134rpx">
        <view class="menu-item" @click="navigateTo('/pages/finance/payment-list')">
          <uni-icons type="wallet" size="40" color="#1a9aff" style="margin-bottom: 10rpx"></uni-icons>
          <view class="item-text"> 收款单 </view>
        </view>
      </uni-grid-item>
    </uni-grid>
  </view>
