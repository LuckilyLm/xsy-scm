...
INSERT INTO `t_serial_number` VALUES (3, '商品编码', 'SP[nnnnnn]', 'none', 1, 1, '商品', 5, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
INSERT INTO `t_serial_number` VALUES (4, '客户编码', 'KH[nnnnnn]', 'none', 1, 1, '客户', NULL, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
INSERT INTO `t_serial_number` VALUES (5, '销售订单号', 'XSD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '销售订单', NULL, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
INSERT INTO `t_serial_number` VALUES (6, '采购单号', 'CGD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '采购单', 8, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
INSERT INTO `t_serial_number` VALUES (7, '收货单号', 'SH[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '收货单', 15, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
INSERT INTO `t_serial_number` VALUES (8, '退款单号', 'TK[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '退款单', NULL, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
INSERT INTO `t_serial_number` VALUES (9, '库存调整单号', 'BSD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '库存调整单', NULL, NULL, '2024-01-08 19:24:46', '2024-01-08 19:24:46');
...
-- ----------------------------
INSERT INTO `t_smart_job` VALUES (1, '示例任务1', 'com.xsy.scm.base.module.support.job.sample.SmartJobSample1', 'cron', '10 15 0/1 * * *', 1, '执行示例任务1', '2025-01-05 19:15:10', 7988, 1, '执行示例任务1', 0, '管理员', '2024-06-17 20:00:46', '2025-01-08 20:07:51');
INSERT INTO `t_smart_job` VALUES (2, '示例任务2', 'com.xsy.scm.base.module.support.job.sample.SmartJobSample2', 'fixed_delay', '120', 1, '执行示例任务2', '2025-01-08 19:56:59', 8144, 2, '执行示例任务2', 0, '管理员', '2024-06-18 20:45:35', '2025-01-08 19:57:00');
...
-- ----------------------------
-- Table structure for t_receivable（应收单：订单签收后生成，09-01 已定）
-- ----------------------------
DROP TABLE IF EXISTS `t_receivable`;
CREATE TABLE `t_receivable`  (
  `receivable_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `receivable_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应收单号，YSD + yyyyMMdd + 流水（按日重置）',
  `order_id` bigint(0) NOT NULL COMMENT '订单ID',
  `customer_id` bigint(0) NULL DEFAULT NULL COMMENT '下单客户ID',
  `settle_customer_id` bigint(0) NULL DEFAULT NULL COMMENT '结算客户ID（集团统一结算时挂集团客户）',
  `settle_type` tinyint(0) NULL DEFAULT NULL COMMENT '结算方式：1 账期支付，2 货到付款，3 在线支付，4 余额充值',
  `amount` decimal(18,2) NOT NULL DEFAULT 0.00 COMMENT '应收金额（不含税，订单核算金额）',
  `received_amount` decimal(18,2) NOT NULL DEFAULT 0.00 COMMENT '已收金额（不含税）',
  `balance_amount` decimal(18,2) NOT NULL DEFAULT 0.00 COMMENT '待收余额（不含税）',
  `due_time` datetime(0) NULL DEFAULT NULL COMMENT '到期日（按客户账期计算）',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 待收款，2 部分收款，3 已结清，4 已冲销',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  `deleted_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除：0 否，1 是（应收不允许物理删除）',
  PRIMARY KEY (`receivable_id`) USING BTREE,
  UNIQUE INDEX `uk_receivable_no`(`receivable_no`) USING BTREE,
  INDEX `idx_order_id`(`order_id`) USING BTREE,
  INDEX `idx_settle_customer_id`(`settle_customer_id`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '应收单' ROW_FORMAT = Dynamic;

-- 应收单号编号规则（YSD + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 10;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (10, '应收单号', 'YSD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '应收单', NULL, NULL, NOW(), NOW());

-- ----------------------------
-- Table structure for t_payment（收款单：客户回款登记，确认后核销应收，09-01 已定）
-- ----------------------------
DROP TABLE IF EXISTS `t_payment`;
CREATE TABLE `t_payment`  (
  `payment_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `payment_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '收款单号，SKD + yyyyMMdd + 流水（按日重置）',
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '关联订单ID',
  `receivable_id` bigint(0) NULL DEFAULT NULL COMMENT '核销目标应收单ID',
  `customer_id` bigint(0) NULL DEFAULT NULL COMMENT '客户ID',
  `amount` decimal(18,2) NOT NULL DEFAULT 0.00 COMMENT '收款金额（不含税）',
  `pay_channel` tinyint(0) NULL DEFAULT NULL COMMENT '收款渠道：1 现金，2 转账，3 在线支付，4 余额扣减',
  `pay_time` datetime(0) NULL DEFAULT NULL COMMENT '收款时间',
  `proof_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '凭证图片',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 待确认，2 已确认，3 已驳回',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  `deleted_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除：0 否，1 是（收款记录不允许物理删除）',
  PRIMARY KEY (`payment_id`) USING BTREE,
  UNIQUE INDEX `uk_payment_no`(`payment_no`) USING BTREE,
  INDEX `idx_customer_id`(`customer_id`) USING BTREE,
  INDEX `idx_receivable_id`(`receivable_id`) USING BTREE,
  INDEX `idx_order_id`(`order_id`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '收款单' ROW_FORMAT = Dynamic;

-- 收款单号编号规则（SKD + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 11;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (11, '收款单号', 'SKD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '收款单', NULL, NULL, NOW(), NOW());

-- 供应商编码编号规则（GYS + 6 位流水，不重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 12;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (12, '供应商编码', 'GYS[nnnnnn]', 'none', 1, 1, '供应商', NULL, NULL, NOW(), NOW());

-- 财务管理菜单（应收单 / 收款单），09-01 财务闭环
DELETE FROM `t_menu` WHERE `menu_id` IN (1000, 1001, 1002);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1000, '财务管理', 1, 0, 60, NULL, NULL, 'MoneyCollectOutlined', 1, 0, 1),
(1001, '应收单', 2, 1000, 1, '/finance/receivable', '/business/finance/receivable-list.vue', NULL, 1, 0, 1),
(1002, '收款单', 2, 1000, 2, '/finance/payment', '/business/finance/payment-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P1 供应商协同（模块 14，对标蔬东坡 16.5 / 17.1 / 17.4 / 17.5）
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_supplier_account`  (
  `account_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `supplier_id` bigint(0) NOT NULL COMMENT '供应商ID',
  `account` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '登录账号',
  `mobile` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '手机号',
  `password` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '密码（加密存储，禁止明文）',
  `openid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '微信openid（小程序登录用）',
  `login_version` int(0) NOT NULL DEFAULT 0 COMMENT '登录态版本号，改密/禁用后+1，使历史登录态失效',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 启用，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  `deleted_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除：0 否，1 是',
...
CREATE TABLE `t_supplier_product_apply`  (
  `apply_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `apply_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '提报单号，SPB + yyyyMMdd + 4 位流水',
  `supplier_id` bigint(0) NOT NULL COMMENT '供应商ID',
  `product_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品名称',
  `alias` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品别名（≤20 字）',
  `category_id` bigint(0) NULL DEFAULT NULL COMMENT '拟归类ID',
  `supply_price` decimal(18,4) NOT NULL DEFAULT 0.0000 COMMENT '供货价（不含税）',
  `last_purchase_price` decimal(18,4) NOT NULL DEFAULT 0.0000 COMMENT '最近一次进价（不含税，受权限控制）',
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品图片（文件服务）',
  `audit_status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '审核状态：1 待审核，2 已通过，3 已驳回',
  `reject_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '驳回原因',
  `product_id` bigint(0) NULL DEFAULT NULL COMMENT '审核通过后生成的商品ID',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '供应商商品提报' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_supplier_manufacturer`  (
  `manufacturer_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `supplier_id` bigint(0) NOT NULL COMMENT '供应商ID',
  `manufacturer_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '厂商名称',
  `qualification_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '资质证件（文件服务）',
  `qualification_expire_date` date NULL DEFAULT NULL COMMENT '资质到期日期（支持预警）',
  `inspect_report_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '质检报告文件（文件服务）',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 启用，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  ...
  INDEX `idx_supplier_id`(`supplier_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '供应商厂商信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_supplier_statement`  (
  `statement_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `statement_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '对账单号，DZD + yyyyMMdd + 4 位流水',
  `supplier_id` bigint(0) NOT NULL COMMENT '供应商ID',
  ...
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 待供应商确认，2 供应商已确认，3 已结算，4 已驳回',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  UNIQUE INDEX `uk_statement_no`(`statement_no`) USING BTREE,
  INDEX `idx_supplier_id`(`supplier_id`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '供应商对账单' ROW_FORMAT = Dynamic;

-- 商品提报单号编号规则（SPB + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 13;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (13, '商品提报单号', 'SPB[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '商品提报单', NULL, NULL, NOW(), NOW());

-- 供应商对账单号编号规则（DZD + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 14;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (14, '供应商对账单号', 'DZD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '供应商对账单', NULL, NULL, NOW(), NOW());

-- 供应商协同菜单（模块 14）
DELETE FROM `t_menu` WHERE `menu_id` IN (1010, 1011, 1012, 1013, 1014);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1010, '供应商协同', 1, 0, 70, NULL, NULL, 'ShopOutlined', 1, 0, 1),
(1011, '供应商账号', 2, 1010, 1, '/supplier/account', '/business/supplier/account-list.vue', NULL, 1, 0, 1),
(1012, '商品提报', 2, 1010, 2, '/supplier/productApply', '/business/supplier/product-apply-list.vue', NULL, 1, 0, 1),
(1013, '厂商信息', 2, 1010, 3, '/supplier/manufacturer', '/business/supplier/manufacturer-list.vue', NULL, 1, 0, 1),
(1014, '供应商对账单', 2, 1010, 4, '/supplier/statement', '/business/supplier/statement-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P1 采购询价报价（P1-2，归属 05 采购，对标蔬东坡 16.5 / 17.3）
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_inquiry`  (
  `inquiry_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `inquiry_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '询价单号，XJD + yyyyMMdd + 4 位流水',
  `inquiry_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '询价单名称',
  `valid_start` datetime(0) NOT NULL COMMENT '询价有效开始时间',
  `valid_end` datetime(0) NOT NULL COMMENT '询价有效结束时间',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 待报价，2 报价中，3 已完成，4 已取消',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  UNIQUE INDEX `uk_inquiry_no`(`inquiry_no`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '询价单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_inquiry_item`  (
  `item_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `inquiry_id` bigint(0) NOT NULL COMMENT '询价单ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '询价明细' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_inquiry_quote`  (
  `quote_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `inquiry_id` bigint(0) NOT NULL COMMENT '询价单ID',
  `item_id` bigint(0) NOT NULL COMMENT '询价明细ID',
  `supplier_id` bigint(0) NOT NULL COMMENT '供应商ID',
  `quote_price` decimal(18,4) NOT NULL DEFAULT 0.0000 COMMENT '报价（不含税）',
  `quote_time` datetime(0) NULL DEFAULT NULL COMMENT '报价时间',
  `score` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT '供应商综合评分（0~100）',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  UNIQUE INDEX `uk_item_supplier`(`item_id`, `supplier_id`) USING BTREE,
  INDEX `idx_inquiry_id`(`inquiry_id`) USING BTREE,
  INDEX `idx_supplier_id`(`supplier_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '供应商报价' ROW_FORMAT = Dynamic;

-- 询价单号编号规则（XJD + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 15;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (15, '询价单号', 'XJD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '询价单', NULL, NULL, NOW(), NOW());

-- 采购询价菜单（采购管理父级 + 询价报价）
DELETE FROM `t_menu` WHERE `menu_id` IN (1020, 1021);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1020, '采购管理', 1, 0, 80, NULL, NULL, 'ShoppingOutlined', 1, 0, 1),
(1021, '询价报价', 2, 1020, 1, '/purchase/inquiry', '/business/purchase/inquiry-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P1 商品转换单（P1-3，归属 06 库存，对标蔬东坡 17.1 / 17.3）
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_product_convert`  (
  `convert_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `convert_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '转换单号，ZHD + yyyyMMdd + 4 位流水',
  `convert_type` tinyint(0) NOT NULL DEFAULT 1 COMMENT '转换类型：1 整件拆零，2 组合拆分',
  `warehouse_id` bigint(0) NOT NULL DEFAULT 1 COMMENT '仓库ID（单仓库，字段保留）',
  `source_type` tinyint(0) NOT NULL DEFAULT 1 COMMENT '来源：1 手工创建，2 发货差异表批量转换',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 待审核，2 已完成，3 已驳回',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  UNIQUE INDEX `uk_convert_no`(`convert_no`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品转换单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- 商品转换明细（一品转多品时同一原商品多行）
-- ----------------------------
DROP TABLE IF EXISTS `t_product_convert_item`;
CREATE TABLE `t_product_convert_item`  (
  `item_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `convert_id` bigint(0) NOT NULL COMMENT '转换单ID',
  `source_product_id` bigint(0) NOT NULL COMMENT '原商品ID',
  `source_sku_id` bigint(0) NULL DEFAULT NULL COMMENT '原规格ID',
  ...
  `target_product_id` bigint(0) NOT NULL COMMENT '目标商品ID',
  `target_sku_id` bigint(0) NULL DEFAULT NULL COMMENT '目标规格ID',
  ...
  `deleted_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除：0 否，1 是',
  PRIMARY KEY (`item_id`) USING BTREE,
  INDEX `idx_convert_id`(`convert_id`) USING BTREE,
  INDEX `idx_source_product_id`(`source_product_id`) USING BTREE,
  INDEX `idx_target_product_id`(`target_product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品转换明细' ROW_FORMAT = Dynamic;

-- 商品转换单号编号规则（ZHD + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 16;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (16, '商品转换单号', 'ZHD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '商品转换单', NULL, NULL, NOW(), NOW());

-- 商品转换菜单（库房管理父级 + 商品转换）
DELETE FROM `t_menu` WHERE `menu_id` IN (1030, 1031);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1030, '库房管理', 1, 0, 90, NULL, NULL, 'DatabaseOutlined', 1, 0, 1),
(1031, '商品转换', 2, 1030, 1, '/stock/productConvert', '/business/stock/product-convert-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P1 客户折扣率 / 客户商品别名 / 商品条码（P1-4 / P1-7 / P1-5）
-- 对标蔬东坡 17.5 / 17.4 / 16.3 / 17.4
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_customer_discount`  (
  `discount_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `customer_id` bigint(0) NOT NULL COMMENT '客户ID',
  `scope_type` tinyint(0) NOT NULL DEFAULT 1 COMMENT '折扣范围：1 统一折扣，2 按商品，3 按分类',
  `product_id` bigint(0) NULL DEFAULT NULL COMMENT '商品ID（scope_type=2 时使用）',
  `category_id` bigint(0) NULL DEFAULT NULL COMMENT '分类ID（scope_type=3 时使用）',
  `discount_rate` decimal(18,4) NOT NULL DEFAULT 1.0000 COMMENT '折扣率（0~1，1 表示不打折）',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 生效，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '客户折扣率（计算折前价）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_customer_product_alias`  (
  `alias_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `customer_id` bigint(0) NOT NULL COMMENT '客户ID',
  `product_id` bigint(0) NOT NULL COMMENT '商品ID',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT '规格ID',
  `alias_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '别名',
  `alias_desc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '别名描述（≤50 字）',
  `sub_alias_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '副别名',
  `sub_alias_desc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '副别名描述（≤50 字）',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  UNIQUE INDEX `uk_customer_product_sku`(`customer_id`, `product_id`, `sku_id`) USING BTREE,
  INDEX `idx_product_id`(`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '客户商品别名' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_product_barcode`  (
  `barcode_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `product_id` bigint(0) NOT NULL COMMENT '商品ID',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT '规格ID',
  `barcode` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '条形码（唯一）',
  `unit` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '对应单位',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  INDEX `idx_product_id`(`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品条码' ROW_FORMAT = Dynamic;

-- 客户折扣率 / 客户商品别名菜单
DELETE FROM `t_menu` WHERE `menu_id` IN (1040, 1041, 1042);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1040, '客户管理', 1, 0, 100, NULL, NULL, 'TeamOutlined', 1, 0, 1),
(1041, '客户折扣率', 2, 1040, 1, '/customer/discount', '/business/customer/discount-list.vue', NULL, 1, 0, 1),
(1042, '客户商品别名', 2, 1040, 2, '/customer/productAlias', '/business/customer/product-alias-list.vue', NULL, 1, 0, 1);

-- 商品条码菜单
DELETE FROM `t_menu` WHERE `menu_id` IN (1050, 1051);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1050, '商品档案', 1, 0, 110, NULL, NULL, 'AppstoreOutlined', 1, 0, 1),
(1051, '商品条码', 2, 1050, 1, '/product/barcode', '/business/product/barcode-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P1 打印模板（P1-8，归属 10 后台管理，对标蔬东坡 17.4 / 17.5）
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_print_template`  (
  `template_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `biz_type` tinyint(0) NOT NULL COMMENT '业务类型：1 采购单，2 发货单，3 分拣小票，4 询价报价单',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板内容（HTML，{{key}} 占位）',
  `paper_size` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '纸张规格（A4 / 58mm / 80mm）',
  `default_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '是否默认模板：0 否，1 是',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 启用，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '打印模板' ROW_FORMAT = Dynamic;

-- 打印模板菜单（后台管理父级 + 打印模板）
DELETE FROM `t_menu` WHERE `menu_id` IN (1060, 1061);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1060, '后台管理', 1, 0, 120, NULL, NULL, 'ToolOutlined', 1, 0, 1),
(1061, '打印模板', 2, 1060, 1, '/printTemplate', '/business/print/print-template-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P2 数据大屏（P2-1，模块 15，对标蔬东坡 17.0 / 16.9）
-- 说明：大屏数据只读聚合现有表，本表仅存布局与指标配置
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_screen_config`  (
  `screen_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `screen_code` tinyint(0) NOT NULL COMMENT '大屏编码：1 经营，2 库存，3 采购，4 分拣绩效，5 配送，6 溯源',
  `screen_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '大屏名称',
  `layout_json` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '布局与指标配置（JSON）',
  `refresh_interval` int(0) NULL DEFAULT NULL COMMENT '刷新间隔（秒）',
  `sort_field` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '排序维度',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 启用，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  ...
  INDEX `idx_screen_code`(`screen_code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '数据大屏配置' ROW_FORMAT = Dynamic;

-- 数据大屏菜单
DELETE FROM `t_menu` WHERE `menu_id` IN (1070, 1071);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1070, '数据大屏', 1, 0, 130, NULL, NULL, 'FundProjectionScreenOutlined', 1, 0, 1),
(1071, '大屏配置', 2, 1070, 1, '/screen/config', '/business/screen/screen-config-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P2 财务凭证与外部对接（P2-2，模块 16，对标蔬东坡 13.6 / 17.1 / 17.4 / 16.5）
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_finance_voucher`  (
  `voucher_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `voucher_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '凭证号，PZD + yyyyMMdd + 4 位流水',
  `voucher_date` date NOT NULL COMMENT '凭证日期',
  `voucher_type` tinyint(0) NOT NULL COMMENT '凭证类型：1 收款，2 付款，3 应收，4 应付，5 费用',
  `biz_type` tinyint(0) NULL DEFAULT NULL COMMENT '关联业务类型',
  `biz_id` bigint(0) NULL DEFAULT NULL COMMENT '关联业务单ID',
  ...
  `sync_status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '同步状态：1 未同步，2 同步中，3 同步成功，4 同步失败',
  `external_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '外部系统单据号',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '凭证状态：1 已生成，2 已作废',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  INDEX `idx_voucher_type`(`voucher_type`) USING BTREE,
  INDEX `idx_biz`(`biz_type`, `biz_id`) USING BTREE,
  INDEX `idx_sync_status`(`sync_status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会计凭证' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_voucher_entry`  (
  `entry_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `voucher_id` bigint(0) NOT NULL COMMENT '凭证ID',
  `subject_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会计科目编码',
  `subject_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '会计科目名称',
  `direction` tinyint(0) NOT NULL COMMENT '借贷方向：1 借，2 贷',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '凭证分录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_external_config`  (
  `config_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `system_type` tinyint(0) NOT NULL COMMENT '系统类型：1 金蝶云星空，2 金蝶云星瀚，3 用友T+，4 用友U8，5 溯源平台，6 团餐平台',
  `api_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '接口地址',
  `app_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '应用Key',
  `app_secret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '应用密钥（加密存储）',
  `field_mapping_json` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '字段映射配置（JSON）',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 启用，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '外部系统配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_invoice`  (
  `invoice_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `invoice_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发票号',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单ID',
  `relate_invoice_nos` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '关联发票号（多张逗号分隔）',
  `amount` decimal(18,2) NOT NULL DEFAULT 0.00 COMMENT '价税合计',
  `tax_rate` decimal(18,4) NOT NULL DEFAULT 0.0000 COMMENT '税率',
  `status` tinyint(0) NOT NULL DEFAULT 2 COMMENT '状态：1 可开票，2 已开票，3 已红冲',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  `deleted_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除：0 否，1 是',
  PRIMARY KEY (`invoice_id`) USING BTREE,
  UNIQUE INDEX `uk_invoice_no`(`invoice_no`) USING BTREE,
  INDEX `idx_order_id`(`order_id`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '发票' ROW_FORMAT = Dynamic;

-- 会计凭证号编号规则（PZD + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 17;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (17, '会计凭证号', 'PZD[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '会计凭证', NULL, NULL, NOW(), NOW());

-- 财务对接菜单（父级 + 会计凭证 / 外部系统配置 / 发票）
DELETE FROM `t_menu` WHERE `menu_id` IN (1080, 1081, 1082, 1083);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1080, '财务对接', 1, 0, 140, NULL, NULL, 'AccountBookOutlined', 1, 0, 1),
(1081, '会计凭证', 2, 1080, 1, '/finance/voucher', '/business/finance/voucher-list.vue', NULL, 1, 0, 1),
(1082, '外部系统配置', 2, 1080, 2, '/finance/externalConfig', '/business/finance/external-config-list.vue', NULL, 1, 0, 1),
(1083, '发票', 2, 1080, 3, '/finance/invoice', '/business/finance/invoice-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P2 溯源（P2-3，模块 13，对标蔬东坡 17.5 生产批号模式 / 17.4 检测报告与保质期）
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_trace_batch`  (
  `batch_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `batch_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '批次号，PCB + yyyyMMdd + 4 位流水',
  `product_id` bigint(0) NOT NULL COMMENT '商品ID',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT '规格ID',
  `supplier_id` bigint(0) NULL DEFAULT NULL COMMENT '供应商ID',
  `manufacturer_id` bigint(0) NULL DEFAULT NULL COMMENT '厂商ID',
  `produce_batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '生产批号',
  `origin_place` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '产地',
  `produce_date` date NOT NULL COMMENT '生产/采收日期',
  `shelf_life_unit` tinyint(0) NULL DEFAULT NULL COMMENT '保质期单位：1 天，2 月',
  `shelf_life_value` int(0) NULL DEFAULT NULL COMMENT '保质期数值',
  `expire_date` date NULL DEFAULT NULL COMMENT '到期日期',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 有效，2 已过期，3 已作废',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  UNIQUE INDEX `uk_trace_batch_no`(`batch_no`) USING BTREE,
  INDEX `idx_product_id`(`product_id`) USING BTREE,
  INDEX `idx_supplier_id`(`supplier_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '溯源批次（生产批号）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_trace_inspect`  (
  `inspect_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `batch_id` bigint(0) NULL DEFAULT NULL COMMENT '关联溯源批次ID',
  `product_id` bigint(0) NOT NULL COMMENT '商品ID',
  `report_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报告名称',
  `match_mode` tinyint(0) NOT NULL DEFAULT 2 COMMENT '匹配模式：1 绑定采购单，2 绑定生产批号',
  `report_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '报告图片',
  `pdf_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '报告PDF',
  `inspect_date` date NULL DEFAULT NULL COMMENT '检测日期',
  `inspect_org` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '检测机构',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 有效，2 已作废',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  INDEX `idx_product_id`(`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '检测报告' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_trace_code`  (
  `code_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `trace_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '唯一溯源码',
  `code_type` tinyint(0) NOT NULL DEFAULT 1 COMMENT '类型：1 批次码',
  `product_id` bigint(0) NOT NULL COMMENT '商品ID',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT '规格ID',
  `batch_id` bigint(0) NOT NULL COMMENT '关联溯源批次ID',
  `qrcode_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '二维码图片',
  `status` tinyint(0) NOT NULL DEFAULT 2 COMMENT '状态：1 未启用，2 已启用，3 已作废',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_user_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人姓名',
  ...
  INDEX `idx_batch_id`(`batch_id`) USING BTREE,
  INDEX `idx_product_id`(`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '溯源码' ROW_FORMAT = Dynamic;

-- 溯源批次编号规则（PCB + 年月日 + 流水，按日重置）
DELETE FROM `t_serial_number` WHERE `serial_number_id` = 18;
INSERT INTO `t_serial_number`(`serial_number_id`, `business_name`, `format`, `rule_type`, `init_number`, `step_random_range`, `remark`, `last_number`, `last_time`, `update_time`, `create_time`)
VALUES (18, '溯源批次号', 'PCB[yyyy][mm][dd][nnnnn]', 'day', 1, 10, '溯源批次', NULL, NULL, NOW(), NOW());

-- 溯源菜单（父级 + 溯源批次 / 检测报告 / 溯源码）
DELETE FROM `t_menu` WHERE `menu_id` IN (1090, 1091, 1092, 1093);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1090, '溯源管理', 1, 0, 150, NULL, NULL, 'SafetyCertificateOutlined', 1, 0, 1),
(1091, '溯源批次', 2, 1090, 1, '/trace/batch', '/business/trace/trace-batch-list.vue', NULL, 1, 0, 1),
(1092, '检测报告', 2, 1090, 2, '/trace/inspect', '/business/trace/trace-inspect-list.vue', NULL, 1, 0, 1),
(1093, '溯源码', 2, 1090, 3, '/trace/code', '/business/trace/trace-code-list.vue', NULL, 1, 0, 1);

-- =============================================================
-- P2 外部平台对接（P2-4，模块 17，对标蔬东坡 17.3 / 17.4 / 16.5 / 17.2）
-- 说明：授权配置复用 t_external_config（见 16 财务对接），本模块只需映射与同步日志
-- 依据：docs/database/07-补充模块P1.sql
-- =============================================================
...
CREATE TABLE `t_external_mapping`  (
  `mapping_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `system_type` tinyint(0) NOT NULL COMMENT '平台类型：1 金蝶云星空，2 金蝶云星瀚，3 用友T+，4 用友U8，5 溯源平台，6 团餐平台',
  `biz_type` tinyint(0) NOT NULL COMMENT '映射对象：1 商品，2 客户，3 供应商',
  `local_id` bigint(0) NOT NULL COMMENT '系统内ID',
  `external_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '外部平台ID',
  `convert_ratio` decimal(18,4) NOT NULL DEFAULT 1.0000 COMMENT '单位转换系数（未填默认1）',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态：1 启用，2 停用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  ...
  INDEX `idx_system_biz`(`system_type`, `biz_type`) USING BTREE,
  INDEX `idx_local_id`(`local_id`) USING BTREE,
  INDEX `idx_external_id`(`external_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '外部平台映射' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_external_sync_log`  (
  `log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `system_type` tinyint(0) NOT NULL COMMENT '平台类型',
  `biz_type` tinyint(0) NOT NULL COMMENT '业务单据类型',
  `biz_id` bigint(0) NOT NULL COMMENT '业务单据ID',
  `sync_type` tinyint(0) NOT NULL COMMENT '同步方向：1 上报，2 拉取',
  `sync_status` tinyint(0) NOT NULL DEFAULT 3 COMMENT '同步状态：1 成功，2 失败，3 待同步',
  ...
  `deleted_flag` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除：0 否，1 是',
  PRIMARY KEY (`log_id`) USING BTREE,
  INDEX `idx_system_biz`(`system_type`, `biz_type`, `biz_id`) USING BTREE,
  INDEX `idx_sync_status`(`sync_status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '外部平台同步日志' ROW_FORMAT = Dynamic;

-- 外部平台对接菜单（父级 + 平台映射 / 同步日志）
DELETE FROM `t_menu` WHERE `menu_id` IN (1100, 1101, 1102);
INSERT INTO `t_menu` (`menu_id`, `menu_name`, `menu_type`, `parent_id`, `sort`, `path`, `component`, `icon`, `visible_flag`, `deleted_flag`, `create_user_id`) VALUES
(1100, '外部平台对接', 1, 0, 160, NULL, NULL, 'ApiOutlined', 1, 0, 1),
(1101, '平台映射', 2, 1100, 1, '/external/mapping', '/business/external/mapping-list.vue', NULL, 1, 0, 1),
(1102, '同步日志', 2, 1100, 2, '/external/syncLog', '/business/external/sync-log-list.vue', NULL, 1, 0, 1);
