package com.xsy.scm.admin.module.business.oa.invoice.service;
...
import com.xsy.scm.admin.module.business.oa.invoice.dao.InvoiceDao;
import com.xsy.scm.admin.module.business.oa.invoice.domain.*;
 ...
 */
// finance 模块存在同名 InvoiceService，显式指定 Bean 名以避免 Spring 扫描冲突
@Service("oaInvoiceService")
@Slf4j
public class InvoiceService {

    @Resource(name = "oaInvoiceDao")
