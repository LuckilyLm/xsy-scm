package com.xsy.scm.admin.module.business.oa.invoice.dao;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.xsy.scm.admin.module.business.oa.invoice.domain.InvoiceEntity;
 ...
 */
@Mapper
// finance 模块存在同名 InvoiceDao，显式指定 Bean 名以避免 Spring 扫描冲突（接口路径与 URL 均不变）
@Repository("oaInvoiceDao")
