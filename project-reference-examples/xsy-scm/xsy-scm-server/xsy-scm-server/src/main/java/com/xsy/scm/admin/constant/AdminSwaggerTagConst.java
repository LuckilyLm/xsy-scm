package com.xsy.scm.admin.constant;
...
public class AdminSwaggerTagConst extends SwaggerTagConst {
    ...
    public static class SupplyChain {
        ...
        public static final String SCM_PRODUCT = "供应链-商品管理";

        public static final String SCM_CUSTOMER = "供应链-客户管理";

        public static final String SCM_ORDER = "供应链-订单管理";

        public static final String SCM_PURCHASE = "供应链-采购管理";

        public static final String SCM_STOCK = "供应链-库存管理";

        public static final String SCM_PRINT = "供应链-打印模板";

        public static final String SCM_SCREEN = "供应链-数据大屏";
