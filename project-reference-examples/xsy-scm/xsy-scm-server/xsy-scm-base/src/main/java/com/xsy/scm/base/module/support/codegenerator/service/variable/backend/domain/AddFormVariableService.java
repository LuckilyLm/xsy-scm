package com.xsy.scm.base.module.support.codegenerator.service.variable.backend.domain;

import cn.hutool.core.bean.BeanUtil;
import com.xsy.scm.base.common.util.SmartStringUtil;
import com.xsy.scm.base.module.support.codegenerator.constant.CodeFrontComponentEnum;
import com.xsy.scm.base.module.support.codegenerator.domain.form.CodeGeneratorConfigForm;
import com.xsy.scm.base.module.support.codegenerator.domain.model.CodeField;
import com.xsy.scm.base.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
import com.xsy.scm.base.module.support.codegenerator.domain.model.CodeInsertAndUpdateField;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import com.xsy.scm.base.common.swagger.SchemaEnum;");
                packageList.add("import com.xsy.scm.base.common.validator.enumeration.CheckEnum;");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import com.xsy.scm.base.common.json.deserializer.DictDataDeserializer;");
            }
            ...
            if (CodeFrontComponentEnum.FILE_UPLOAD.equalsValue(field.getFrontComponent())) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import com.xsy.scm.base.common.json.deserializer.FileKeyVoDeserializer;");
            }
