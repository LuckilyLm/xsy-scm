...
def verify():
    ...
    for line in (ROOT / 'docs/architecture/w1-applied-migrations.sha256').read_text(encoding='utf-8-sig').splitlines():
    ...
    result = {'files': len(entries), 'head': head, 'approved_difference': '.gitignore: .workbuddy-ai + **/.runtime/',
