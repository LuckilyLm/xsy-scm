...
import type { ApproveReturnPayload, CompleteRefundPayload, OrderReturn, OrderReturnPayload, Refund, ReturnPage, RefundPage, SalesPageParams } from '../types/sales';
...
export async function approveReturn(id: number, payload: ApproveReturnPayload, key: string) { await apiClient.post<number>(`/order-returns/${id}/approve`, payload, idempotency(key)); }
