...
export const customerVisibilityApi={query:(form:{pageNum:number;pageSize:number;customerId?:ScmId;skuId?:ScmId;visibilityPolicy?:string})=>postRequest('/scm/customer/visibility/reverse/query',form) as unknown as Promise<ScmResponse<ScmPage<VisibilityRow>>>};
