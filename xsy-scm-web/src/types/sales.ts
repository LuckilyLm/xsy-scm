...
export interface CustomerSkuVisibility {
    id?: number;
    version?: number;
    skuId: number;
}
...
export interface CustomerDetail extends CustomerSummary {
    visibilities: CustomerSkuVisibility[];
}
...
export interface ActualQuantityPayload {
    version: number;
...
export interface ApproveReturnPayload {
    version: number;
    items: Array<{ returnItemId: number; version: number; approvedQuantity: string }>;
}
