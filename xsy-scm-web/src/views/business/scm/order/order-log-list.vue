...
const columns=ref<TableColumnsType<LogRow>>([{title:'时间',dataIndex:'createdAt',width:210, customRender: ({ text }) => datetime(text) },{title:'操作',dataIndex:'operationType',width:140},{title:'操作人',dataIndex:'operatorName',width:140},{title:'原因',dataIndex:'reason',width:200},{title:'操作',dataIndex:'action',align:'right',fixed:'right',width:240}]);
