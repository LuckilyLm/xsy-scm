...
export function PurchaseReceiptPage() {
    ...
    const confirmations = useQuery({
        queryKey: ['receipt-confirmations', id],
        queryFn: () => fetchReceiptConfirmations(id)
    });
        ...
        <PageContainer>
            <Space direction="vertical" style={{width: '100%'}}>
                ...
                <Permission authority={AUTHORITIES.purchaseManage}>
                    <Button type="primary" loading={submitting} disabled={readOnly}
                            onClick={submit}>确认本次收货</Button>
                </Permission>
                <Table
                    title={() => '确认历史'}
