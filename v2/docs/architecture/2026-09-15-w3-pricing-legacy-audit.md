...
| V2 商品 DDL | `v2/xsy-scm-v2-server/sa-admin/src/main/resources/db/migration/V6__scm_product.sql` |
| V2 客户 DDL | `.../V8__scm_customer_supplier.sql` |
| V2 SKU 选择器现状 | `v2/xsy-scm-v2-web/src/components/business/scm/sku-select/index.vue:15-16,61-85` |
