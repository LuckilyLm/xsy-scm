...
@Data public class PriceBatchRowForm {
 private Integer rowNumber; private Long customerTypeId; private Long skuId;
 @JsonDeserialize(using=ScmStrictDecimalStringDeserializer.class) private String unitPrice;
 private OffsetDateTime effectiveFrom; private OffsetDateTime effectiveTo;
}
