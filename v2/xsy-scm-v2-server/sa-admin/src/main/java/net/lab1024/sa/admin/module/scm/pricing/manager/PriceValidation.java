...
@Component @RequiredArgsConstructor public class PriceValidation {
    ...
    public void requireSellable(Long id) {
        ...
        if(unavailable(rows.isEmpty()?null:rows.getFirst(),true)!=null) throw new ScmBusinessException(SKU_NOT_SELLABLE);
    }
