...
@Service @RequiredArgsConstructor public class AgreementPriceQueryService {
    ...
    public AgreementPriceVO detail(Long id) {var v=dao.detail(id);if(v==null) throw new ScmBusinessException(AGREEMENT_PRICE_NOT_FOUND);return v;}
}
