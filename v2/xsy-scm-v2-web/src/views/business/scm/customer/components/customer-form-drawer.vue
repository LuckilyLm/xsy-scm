  ...
  <a-drawer v-model:open="visible" :title="title" width="780" @close="close">
    <a-spin :spinning="loading">
      ...
      <a-form ref="formRef" :model="form" layout="vertical">
        <a-row :gutter="16">
          <a-col :span="12">
            <a-form-item label="客户编码" name="customerCode" :rules="[{ required: true, whitespace: true, message: '请输入客户编码' }]">
              <a-input v-model:value="form.customerCode" :maxlength="64" placeholder="保存时自动转为大写" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="客户名称" name="name" :rules="[{ required: true, whitespace: true, message: '请输入客户名称' }]">
        ...
        <a-row :gutter="16">
          <a-col :span="12">
            <a-form-item label="客户类型" name="customerTypeId" :rules="[{ required: true, message: '请选择客户类型' }]">
