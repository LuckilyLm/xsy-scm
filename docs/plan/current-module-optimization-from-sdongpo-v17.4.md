...
> 规划时 Flyway 最大版本：`V43`（**已过期**，当前为 `V49`）  
> 收口核对：2026-09-23 于 `main @ f3b3f20`  
...
> 审计修订：2026-09-22；本文件原为待实施计划，其 Wave 1～8 已于 2026-09-23 实施并验收，正文中「新增验收项不代表已实现」的措辞相应失效。既有模型约束直接沿用，尚未确认的业务口径列入 §1.3，不能由实施者自行补成永久规则。
