...
ALTER TABLE purchase_receipt_item
    ALTER COLUMN actual_weight TYPE NUMERIC,
    DROP CONSTRAINT ck_purchase_receipt_item_weight_source,
...
ALTER TABLE receipt_weighing_record
    ALTER COLUMN raw_reading TYPE NUMERIC,
    ALTER COLUMN confirmed_reading TYPE NUMERIC,
    ALTER COLUMN scale_precision TYPE NUMERIC,
    DROP CONSTRAINT ck_receipt_weighing_record_source,
    ADD CONSTRAINT ck_receipt_weighing_record_source CHECK (source = 'MANUAL');

ALTER TABLE inventory
    DROP CONSTRAINT ck_inventory_quantity;

ALTER TABLE inventory_movement
    DROP CONSTRAINT ck_inventory_movement_source_type,
    DROP CONSTRAINT ck_inventory_movement_quantities,
