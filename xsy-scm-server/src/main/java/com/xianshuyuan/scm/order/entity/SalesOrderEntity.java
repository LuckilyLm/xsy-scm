...
public class SalesOrderEntity {
    ...
    public String getCustomerCodeSnapshot() {
        return customerCodeSnapshot;
    }

    public void setCustomerCodeSnapshot(String v) {
        customerCodeSnapshot = v;
    }
    ...
    public void setCustomerNameSnapshot(String v) {
        customerNameSnapshot = v;
    }
    ...
    public void setOrderSource(OrderSource v) {
        orderSource = v;
    }
    ...
    public void setOriginalOrderId(Long v) {
        originalOrderId = v;
    }
    ...
    public void setSupplementReason(String v) {
        supplementReason = v;
    }
    ...
    public BigDecimal getOrderedTotalAmount() {
        return orderedTotalAmount;
    }

    public void setOrderedTotalAmount(BigDecimal v) {
        orderedTotalAmount = v;
    }
    ...
    public void setSettlementTotalAmount(BigDecimal v) {
        settlementTotalAmount = v;
    }
