...
public class OrderReturnEntity {
    ...
    public void setStatus(OrderReturnStatus v) {
        status = v;
    }
    ...
    public void setDecisionReason(String v) {
        decisionReason = v;
    }
    ...
    public void setApprovedAt(OffsetDateTime v) {
        approvedAt = v;
    }
    ...
    public void setRejectedAt(OffsetDateTime v) {
        rejectedAt = v;
    }
