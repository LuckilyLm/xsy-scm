...
public final class SalesOrderConverter {
    ...
    public static SalesOrderResponse toResponse(SalesOrderEntity o, List<SalesOrderItemEntity> rows) {
    ...
    public static SalesOrderItemResponse toItem(SalesOrderItemEntity i) {
        boolean locked = i.getLockedUnitPrice() != null;
    ...
    public static String decimal(BigDecimal v) {
        return v == null ? null : v.setScale(4).toPlainString();
    }
}
