...
public class SalesOrderItemEntity {
    ...
    private QuantitySource actualQuantitySource;
    private String actualQuantityReason;
    private BigDecimal draftUnitPrice;
    private PriceSource draftPriceSource;
    ...
    private PriceSource lockedPriceSource;
    ...
    public String getSpecNameSnapshot() {
        return specNameSnapshot;
    }

    public void setSpecNameSnapshot(String v) {
        specNameSnapshot = v;
    }
    ...
    public String getSaleUnitSnapshot() {
        return saleUnitSnapshot;
    }

    public void setSaleUnitSnapshot(String v) {
        saleUnitSnapshot = v;
    }
    ...
    public void setOrderedQuantity(BigDecimal v) {
        orderedQuantity = v;
    }
    ...
    public void setActualQuantity(BigDecimal v) {
        actualQuantity = v;
    }

    public QuantitySource getActualQuantitySource() {
        return actualQuantitySource;
    }

    public void setActualQuantitySource(QuantitySource v) {
        actualQuantitySource = v;
    }

    public String getActualQuantityReason() {
        return actualQuantityReason;
    }

    public void setActualQuantityReason(String v) {
        actualQuantityReason = v;
    }

    public BigDecimal getDraftUnitPrice() {
        return draftUnitPrice;
    }

    public void setDraftUnitPrice(BigDecimal v) {
        draftUnitPrice = v;
    }

    public PriceSource getDraftPriceSource() {
        return draftPriceSource;
    }

    public void setDraftPriceSource(PriceSource v) {
        draftPriceSource = v;
    }

    public Long getDraftPriceSourceId() {
        return draftPriceSourceId;
    }

    public void setDraftPriceSourceId(Long v) {
        draftPriceSourceId = v;
    }

    public Boolean getManualPriceOverride() {
        return manualPriceOverride;
    }

    public void setManualPriceOverride(Boolean v) {
        manualPriceOverride = v;
    }

    public String getManualPriceReason() {
        return manualPriceReason;
    }

    public void setManualPriceReason(String v) {
        manualPriceReason = v;
    }
    ...
    public PriceSource getLockedPriceSource() {
        return lockedPriceSource;
    }

    public void setLockedPriceSource(PriceSource v) {
        lockedPriceSource = v;
    }

    public Long getLockedPriceSourceId() {
        return lockedPriceSourceId;
    }

    public void setLockedPriceSourceId(Long v) {
        lockedPriceSourceId = v;
    }

    public BigDecimal getOrderedLineAmount() {
        return orderedLineAmount;
    }

    public void setOrderedLineAmount(BigDecimal v) {
        orderedLineAmount = v;
    }

    public BigDecimal getSettlementLineAmount() {
        return settlementLineAmount;
    }

    public void setSettlementLineAmount(BigDecimal v) {
        settlementLineAmount = v;
    }
