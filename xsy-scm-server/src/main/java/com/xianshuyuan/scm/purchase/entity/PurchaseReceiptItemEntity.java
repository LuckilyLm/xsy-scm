...
public class PurchaseReceiptItemEntity {
    ...
    public Long getPurchaseOrderItemId(){return purchaseOrderItemId;} public void setPurchaseOrderItemId(Long v){purchaseOrderItemId=v;}
    public Long getSkuId(){return skuId;} public void setSkuId(Long v){skuId=v;}
    public String getSpuCodeSnapshot(){return spuCodeSnapshot;} public void setSpuCodeSnapshot(String v){spuCodeSnapshot=v;}
    ...
    public String getSkuCodeSnapshot(){return skuCodeSnapshot;} public void setSkuCodeSnapshot(String v){skuCodeSnapshot=v;}
    public String getSkuNameSnapshot(){return skuNameSnapshot;} public void setSkuNameSnapshot(String v){skuNameSnapshot=v;}
    public Map<String,String> getSpecValuesSnapshot(){return specValuesSnapshot;} public void setSpecValuesSnapshot(Map<String,String> v){specValuesSnapshot=v;}
    public String getPurchaseUnitSnapshot(){return purchaseUnitSnapshot;} public void setPurchaseUnitSnapshot(String v){purchaseUnitSnapshot=v;}
    public ProductType getProductTypeSnapshot(){return productTypeSnapshot;} public void setProductTypeSnapshot(ProductType v){productTypeSnapshot=v;}
    ...
    public BigDecimal getActualWeight(){return actualWeight;} public void setActualWeight(BigDecimal v){actualWeight=v;}
    public String getWeightUnit(){return weightUnit;} public void setWeightUnit(String v){weightUnit=v;}
    public ReceiptWeighingSource getWeighingSource(){return weighingSource;} public void setWeighingSource(ReceiptWeighingSource v){weighingSource=v;}
    public String getCorrectionReason(){return correctionReason;} public void setCorrectionReason(String v){correctionReason=v;}
