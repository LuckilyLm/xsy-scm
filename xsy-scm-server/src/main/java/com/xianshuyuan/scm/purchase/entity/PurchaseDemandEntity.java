...
public class PurchaseDemandEntity {
    ...
    private Long id;
    private Long salesOrderId, salesOrderItemId, spuId, skuId;
    private String salesOrderNoSnapshot, spuCodeSnapshot, productNameSnapshot, skuCodeSnapshot, skuNameSnapshot;
    ...
    public void setSalesOrderId(Long v) {
        salesOrderId = v;
    }
    ...
    public void setSalesOrderItemId(Long v) {
        salesOrderItemId = v;
    }
    ...
    public String getSalesOrderNoSnapshot() {
        return salesOrderNoSnapshot;
    }

    public void setSalesOrderNoSnapshot(String v) {
        salesOrderNoSnapshot = v;
    }
    ...
    public void setRequiredQuantity(BigDecimal v) {
        requiredQuantity = v;
    }
    ...
    public void setAllocatedQuantity(BigDecimal v) {
        allocatedQuantity = v;
    }
    ...
    public void setFulfilledQuantity(BigDecimal v) {
        fulfilledQuantity = v;
    }
    ...
    public void setDemandDate(LocalDate v) {
        demandDate = v;
    }
