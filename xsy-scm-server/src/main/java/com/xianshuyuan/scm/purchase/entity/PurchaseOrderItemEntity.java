...
public class PurchaseOrderItemEntity {
    ...
    private Long id;
    private Long purchaseOrderId, spuId, skuId;
    ...
    private BigDecimal plannedQuantity, receivedQuantity, purchasePrice, lineAmount;
    private Integer sortOrder, version;
    @TableLogic
    ...
    public void setLineAmount(BigDecimal v) {
        lineAmount = v;
    }
