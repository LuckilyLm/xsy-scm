...
public class PurchaseReceiptEntity {
    ...
    public String getPurchaseOrderNoSnapshot() {
        return purchaseOrderNoSnapshot;
    }

    public void setPurchaseOrderNoSnapshot(String v) {
        purchaseOrderNoSnapshot = v;
    }
    ...
    public void setReceivedAt(OffsetDateTime v) {
        receivedAt = v;
    }
