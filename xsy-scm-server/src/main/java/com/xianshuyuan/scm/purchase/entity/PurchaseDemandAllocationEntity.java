...
public class PurchaseDemandAllocationEntity {
    ...
    Long id;
    Long purchaseDemandId, purchaseOrderItemId, salesOrderId, salesOrderItemId, skuId;
    BigDecimal allocatedQuantity;
    @TableField(typeHandler = JsonbJsonNodeTypeHandler.class, jdbcType = JdbcType.OTHER)
    JsonNode demandSnapshot;
    Integer version;
    Boolean deleted;
    ...
    public void setPurchaseDemandId(Long v) {
        purchaseDemandId = v;
    }
    ...
    public JsonNode getDemandSnapshot() {
        return demandSnapshot;
    }

    public void setDemandSnapshot(JsonNode v) {
        demandSnapshot = v;
    }
