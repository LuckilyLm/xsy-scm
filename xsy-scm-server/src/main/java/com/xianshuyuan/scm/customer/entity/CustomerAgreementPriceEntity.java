...
@TableName("customer_agreement_price")
public class CustomerAgreementPriceEntity {
    ...
    public void setEffectiveFrom(OffsetDateTime v) {
        effectiveFrom = v;
    }
    ...
    public void setEffectiveTo(OffsetDateTime v) {
        effectiveTo = v;
    }
