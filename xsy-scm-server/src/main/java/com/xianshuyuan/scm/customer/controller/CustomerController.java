...
public class CustomerController {
    ...
    @PostMapping public ApiResponse<Long> create(@Valid @RequestBody CustomerSaveRequest request) {
    ...
    @PutMapping("/{id}/status") public ApiResponse<Void> status(@PathVariable long id,
