...
public class InventoryEntity {
    ...
    private String warehouseCodeSnapshot, warehouseNameSnapshot, skuCodeSnapshot, skuNameSnapshot, unit;
    private BigDecimal quantity, averageCost;
    @Version
    ...
    public void setAverageCost(BigDecimal v) {
        averageCost = v;
    }
