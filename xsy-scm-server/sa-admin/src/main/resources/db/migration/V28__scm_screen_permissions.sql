...
VALUES (900, '数据大屏', 1, 0, 900, '/screen', NULL, NULL, NULL, NULL, 'DashboardOutlined', NULL, false, 1)
ON CONFLICT(menu_id) DO NOTHING;
INSERT INTO t_menu(menu_id, menu_name, menu_type, parent_id, sort, path, component, perms_type, api_perms, web_perms,
                   icon, context_menu_id, visible_flag, create_user_id)
VALUES (901, '查询', 3, 900, 901, NULL, NULL, 1, 'scm:screen:query', 'scm:screen:query', NULL, NULL, true, 1)
ON CONFLICT(menu_id) DO NOTHING;
