...
VALUES (1000, '物流配送', 1, 0, 850, '/delivery', NULL, NULL, NULL, NULL, 'CarOutlined', NULL, true, 1),
       (1001, '线路管理', 2, 1000, 1, '/delivery/routes', '/business/scm/delivery/route-list.vue', NULL, NULL, NULL,
        'NodeIndexOutlined', NULL, true, 1),
       (1002, '司机管理', 2, 1000, 2, '/delivery/drivers', '/business/scm/delivery/driver-list.vue', NULL, NULL, NULL,
        'UserOutlined', NULL, true, 1),
       (1003, '车辆管理', 2, 1000, 3, '/delivery/vehicles', '/business/scm/delivery/vehicle-list.vue', NULL, NULL, NULL,
        'CarOutlined', NULL, true, 1);
...
VALUES (1011, '线路查询', 3, 1001, 1011, 1, 'scm:delivery:route:query', 'scm:delivery:route:query', 1001, true, 1),
...
SELECT 1, menu_id
FROM t_menu
WHERE menu_id IN (1000, 1001, 1002, 1003, 1011, 1012, 1013, 1014, 1015, 1016, 1021, 1022, 1031, 1032);
