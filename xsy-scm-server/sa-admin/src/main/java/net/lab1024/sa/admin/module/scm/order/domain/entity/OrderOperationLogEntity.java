...
@Data @TableName(value="order_operation_log",autoResultMap=true)
public class OrderOperationLogEntity {
    ...
    @TableField(typeHandler=OrderJsonbTypeHandler.class, updateStrategy=FieldStrategy.ALWAYS) private Map<String,Object> beforeData;
    @TableField(typeHandler=OrderJsonbTypeHandler.class, updateStrategy=FieldStrategy.ALWAYS) private Map<String,Object> afterData;
