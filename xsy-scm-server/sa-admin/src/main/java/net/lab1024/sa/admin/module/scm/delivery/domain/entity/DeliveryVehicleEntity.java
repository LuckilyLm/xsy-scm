...
public class DeliveryVehicleEntity extends DeliveryRecord {
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String vehicleNo;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String vehicleType;
    @JsonSerialize(using=ScmFixedScale4Serializer.class,nullsUsing=ScmFixedScale4Serializer.class)
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private BigDecimal loadWeight;
    @JsonSerialize(using=ScmFixedScale4Serializer.class,nullsUsing=ScmFixedScale4Serializer.class)
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private BigDecimal loadVolume;
