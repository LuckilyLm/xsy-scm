...
public final class FinanceConstant {
     ...
     * + 1521 scm:finance:receipt:add。这是本仓库既有的「只有 API 能力、还没有页面」正式范式
     ...
     *                       RECEIPT_QUERY_PERM / PAYMENT_QUERY_PERM 设计稿原标 F1-3，
     *                       但 F1-3A 只有写入口、没有查询端点，故不提前种（§16 已按此订正）。
