...
public class ProductImageSyncManager {
    ...
    public void sync(Long spuId, ProductImageChangeSet changes) {
        ...
        for (var form : requested)
            if (!metadata.containsKey(form.getFileKey())) throw new ScmBusinessException(IMAGE_INVALID);
