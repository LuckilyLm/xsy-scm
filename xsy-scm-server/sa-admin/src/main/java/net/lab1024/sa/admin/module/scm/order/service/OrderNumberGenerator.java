...
public class OrderNumberGenerator {
    ...
    public String order() {return format("SO",dao.nextOrder());}
    public String returned() {return format("RT",dao.nextReturn());}
    public String refund() {return format("RF",dao.nextRefund());}
