...
@Service @RequiredArgsConstructor public class PriceHistoryQueryService {
 ...
 public PageResult<PriceHistoryVO> query(PriceHistoryQueryForm form) {
  ...
  form.setSortItemList(java.util.List.of()); var page=SmartPageUtil.convert2PageQuery(form);
