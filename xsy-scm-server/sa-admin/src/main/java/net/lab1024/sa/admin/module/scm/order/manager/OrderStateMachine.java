...
public final class OrderStateMachine {
    ...
    public static void editable(String state) { if(!"DRAFT".equals(state)) throw new ScmBusinessException(ORDER_STATE_INVALID); }
    public static void actualQuantity(String state) { if(!"PENDING".equals(state)) throw new ScmBusinessException(ORDER_STATE_INVALID); }
}
