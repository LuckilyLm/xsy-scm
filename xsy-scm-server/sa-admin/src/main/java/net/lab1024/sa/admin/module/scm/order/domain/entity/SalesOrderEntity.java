...
@Data @TableName(value="sales_order",autoResultMap=true)
public class SalesOrderEntity {
    ...
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String customerCodeSnapshot;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String customerNameSnapshot;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String orderSource;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private Long originalOrderId;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String supplementReason;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String status;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) @JsonSerialize(using=ScmFixedScale4Serializer.class,nullsUsing=ScmFixedScale4Serializer.class) private BigDecimal orderedTotalAmount;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) @JsonSerialize(using=ScmFixedScale4Serializer.class,nullsUsing=ScmFixedScale4Serializer.class) private BigDecimal settlementTotalAmount;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private String settleModeSnapshot;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private OffsetDateTime expectDeliveryTime;
    @TableField(updateStrategy=FieldStrategy.ALWAYS) private Long sellerId;
