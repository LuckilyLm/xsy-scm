...
public class ScmLocationForm {
    ...
    @DecimalMin("-90") @DecimalMax("90") @Digits(integer=2, fraction=8)
    private BigDecimal latitude;
    @Pattern(regexp="GCJ02|WGS84") private String geomCrs;
    @JsonIgnore @AssertTrue(message="经纬度和坐标系必须同时填写或同时清空")
