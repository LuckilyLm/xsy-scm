...
class ProductControllerTest {
    ...
    @Test
    void returnsSmartAdminPaginationEnvelope() throws Exception {
    ...
    @Test
    void validatesPageBoundsAndEmptySku() throws Exception {
    ...
    @Test
    void returnsHttp200With40921AndPreservesMissingProductCode() throws Exception {
    ...
    @Test
    void leavesSmartAdminBusinessAndUnexpectedExceptionsWithGlobalHandler() throws Exception {
