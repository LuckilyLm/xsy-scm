...
class ProductImageChangeSetTest {
    @Test void primarySwitchPreservesIdentityAndSeparatesRemoval() {
        var a=new ProductImageEntity(); a.setId(1L);
        var b=new ProductImageEntity(); b.setId(2L);
        var keep=new ProductImageForm(); keep.setImageId(2L); keep.setVersion(3); keep.setPrimaryFlag(true);
    ...
    @Test void foreignReferenceIsRejected() {
        var foreign=new ProductImageForm(); foreign.setImageId(9L); foreign.setVersion(0);
